...
@dataclass
class PersonalData:
    """A basic initial representation of the user's personal data."""
...
class DataPacket:
    ...
    personal_data: PersonalData = field(default_factory=PersonalData) #TODO: this might want to default to None
    browsing_data: BrowsingData = field(default_factory=BrowsingData) #TODO: this might want to default to None