...
// Model configurations for staging/dev environment
// Dev deployment of chatlab points to staging workbench
export const MODEL_CONFIGS_STAGING: Record<string, ModelConfig> = {
  // Auto Router
  'auto-router': {
    id: 'auto-router',
    name: 'Auto Router',
  ...
  'claude-haiku-4.5': {
    ...
    provider: 'Anthropic',
    agentId: 'agent-1770649459333275468',
    maxTokens: 200000,
    description:
  ...
  'claude-opus-4.6': {
    ...
    provider: 'Anthropic',
    agentId: 'agent-1770649468831102033',
    maxTokens: 1000000,
    description:
      'Opus 4.6 is Anthropic’s strongest model for coding and long-running professional tasks.',
    capabilities: ['advanced-reasoning', 'complex-analysis', 'programming'],
    category: 'coding',
    costTier: 'premium',
    speed: 'slow',
    executionPath: 'openrouter',
  ...
  'qwen3-next-80B-A3B-thinking': {
    ...
    provider: 'Alibaba Cloud',
    agentId: 'agent-1762197222674133905',
    maxTokens: 128000,
  ...
  'kimi-k2-0905': {
    ...
    name: 'Kimi K2 0905',
    provider: 'Moonshot',
    agentId: 'agent-1762197447818261904',
    maxTokens: 128000,
...
// Model configurations for production environment
// Prod deployment of chatlab points to prod workbench
export const MODEL_CONFIGS_PROD: Record<string, ModelConfig> = {
  // Auto Router
  'auto-router': {
    id: 'auto-router',
    name: 'Auto Router',
  ...
  'claude-haiku-4.5': {
    ...
    name: 'Claude Haiku 4.5',
    provider: 'Anthropic',
    agentId: 'agent-1770650027958447605',
    maxTokens: 200000,
    description:
      'Claude Haiku 4.5 is Anthropic’s fastest and most efficient model, delivering near-frontier intelligence at a fraction of the cost and latency of larger Claude models.',
    capabilities: ['fast-responses', 'improved-performance', 'conversation'],
  ...
  'claude-opus-4': {
    ...
    name: 'Claude Opus 4',
    provider: 'Anthropic',
    agentId: 'agent-1770650034102117429',
    maxTokens: 200000,
    description:
      'Most capable Claude model with advanced reasoning and analysis capabilities',
    capabilities: [
...
/**
 * Get the appropriate model configs based on the current environment
 * Dev deployment uses staging configs, prod deployment uses prod configs
 */
export const getModelConfigs = (): Record<string, ModelConfig> => {
