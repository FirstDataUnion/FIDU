...
export const BUILT_IN_BACKGROUND_AGENTS: Array<Pick<BackgroundAgent, 'name' | 'description' | 'promptTemplate' | 'runEveryNTurns' | 'verbosityThreshold' | 'contextWindowStrategy' | 'contextParams' | 'outputSchemaName' | 'customOutputSchema' | 'notifyChannel' | 'isSystem' | 'categories' | 'version'>> = [
  {
    name: 'Ethics Monitor',
