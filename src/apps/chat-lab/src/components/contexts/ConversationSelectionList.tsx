...
export const ConversationSelectionList =
  React.memo<ConversationSelectionListProps>(
    ({ onConversationSelect, currentProfileId }) => {
      const dispatch = useAppDispatch();
      const { items: conversations = [], loading: conversationsLoading } =
      ...
      const filteredConversations = useMemo(() => {
        ...
        return conversations.filter(conversation => {
          return (
            ...
            || conversation.tags.some((tag: string) =>
