...
export const WelcomeLandingPage: React.FC = () => {
  ...
  const { isAuthenticated, isInitialized, isLoading, currentProfile } =
  ...
  const handleGitHubLink = () => {
    window.open(
      'https://github.com/FirstDataUnion/FIDU',
      '_blank',
      'noopener,noreferrer'
    );
  };
    ...
    <Fade in={fadeIn} timeout={300}>
      ...
      >
        <Fade
          in={fadeIn}
          timeout={400}
          style={{ transitionDelay: fadeIn ? '100ms' : '0ms' }}
        >
          <Paper
            elevation={24}
            sx={{
          ...
          >
            ...
            >
              ...
              <Typography variant="body1" sx={{ mb: 3, lineHeight: 1.8 }}>
                ChatLab is a web application that brings together the world's
                leading AI models (ChatGPT, Claude, Gemini, and more) in one
                simple interface. Unlike other platforms, you maintain complete
                control over your data – all your conversations, custom prompts,
                and contexts are stored on your Google Drive, never on our
                servers.
              </Typography>
              ...
              <Box sx={{ mb: 3 }}>
                <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.8 }}>
                  <strong>1. Quick Start:</strong> Use our paid service to
                  access premium AI models instantly – no API keys needed.
                </Typography>
                <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.8 }}>
                  <strong>2. Bring Your Own Keys:</strong> Have API keys
                  already? Use them for free with ChatLab's enhanced interface.
                </Typography>
                <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.8 }}>
                  <strong>3. Explore & Customize:</strong> Browse our prompt
                  library, create contexts from past chats, and tailor the
                  experience to your needs.
                </Typography>
                <Typography variant="body1" sx={{ lineHeight: 1.8 }}>
                  <strong>4. Get Help:</strong> If you need help, please ask a
                  question on our{' '}
                  <Link
                    component="button"
                    variant="body1"
                  ...
                  page (there's a link in the sidebar too).
                </Typography>
              </Box>
              ...
              <Box sx={{ textAlign: 'center', mb: 0 }}>
                <Typography variant="body1" sx={{ lineHeight: 1.8 }}>
                  Ready to take control of your AI conversations? Start chatting
                  now or explore our{' '}
                  <Link
                    component="button"
                    variant="body1"
