    ...
    >
      ...
      <DialogContent>
        <Alert severity="warning" sx={{ mb: 3 }}>
          Your Google Drive connection is missing required permissions. The app
          cannot sync your data without these permissions.
        </Alert>
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            When you authorized the app, there was a checkbox for granting
            access to Google Drive that wasn't selected. Without this
            permission, the app cannot store or sync your data.
          </Typography>
          ...
          <Box sx={{ mt: 2, textAlign: 'center' }}>
            ...
            >
              Look for the Google Drive permission and make sure to check the
              box
            </Typography>
          </Box>
        </Paper>
        ...
        >
          <Typography variant="body2" sx={{ fontStyle: 'italic' }}>
            <strong>Important:</strong> The screenshot above shows exactly what
            to look for. Make sure to check the Google Drive permission box
      ...
      <DialogActions sx={{ px: 3, pb: 3, flexDirection: 'column', gap: 2 }}>
        ...
        >
          Click "Reconnect with Permissions" to go directly to Google's
          authorization screen where you can check the Drive permission box.
        </Typography>
        <Box
          sx={{
            display: 'flex',
