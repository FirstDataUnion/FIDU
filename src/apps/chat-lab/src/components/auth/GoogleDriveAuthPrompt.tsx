...
export default function GoogleDriveAuthPrompt({
  open = true,
  onClose,
}: GoogleDriveAuthPromptProps) {
  ...
  const handleAuthenticate = async () => {
    ...
    try {
      ...
      if (
        'authenticate' in adapter
        && typeof adapter.authenticate === 'function'
      ) {
        await (adapter as any).authenticate();
        console.log(
          'Google Drive authentication initiated - redirecting to OAuth flow'
        );
        ...
        throw new Error(
          'Authentication not supported by current storage adapter'
        );
      }
    } catch (err: any) {
      ...
      <DialogContent sx={{ px: 4, pb: 4 }}>
        <Box sx={{ textAlign: 'center' }}>
          <Typography variant="body1" color="text.secondary" paragraph>
            ...
            This allows FIDU Chat Lab to store your conversations securely in
            your personal Google Drive.
          </Typography>

          <Typography variant="body2" color="text.secondary" paragraph>
            Your data will be stored in a private folder that only you can
            access.
          </Typography>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              When Google asks for permissions, make sure to check the box for
              Google Drive access:
            </Typography>
            ...
            <Box sx={{ textAlign: 'center' }}>
              ...
              >
                Look for this Google Drive permission and make sure to check the
          ...
          <Stack spacing={3} alignItems="center" sx={{ mb: 3 }}>
            <Button
              ...
              size="large"
              startIcon={
                isAuthenticating ? <CircularProgress size={20} /> : <Google />
              }
          ...
          >
            ...
            <Box component="ol" sx={{ pl: 2, m: 0 }}>
              ...
              <Typography
                ...
                sx={{ mb: 1 }}
              >
                <strong>Check the Google Drive permission box</strong> (see
                guide above)
              </Typography>
