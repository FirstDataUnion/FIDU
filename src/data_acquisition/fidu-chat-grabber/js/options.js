/**
 * FIDU Chat Grabber - Options Script
 * 
 * Responsible for:
 * - Loading user preferences
 * - Saving user preferences
 * - Handling options page interactions
 * - Managing FIDU Vault authentication settings
 */
...
const defaultSettings = {
  ...
  useFiduCore: true, // Default to using FIDU Vault backend
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function saveSettings() {
    const settings = {
      ...
      useFiduCore: true, // Always use FIDU Vault backend
